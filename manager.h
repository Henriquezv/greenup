...
/* ==================== */
struct guest_info {
    char hostname[20*MAX_GUESTS_ALLOWED*2];
    char ip[16*MAX_GUESTS_ALLOWED*2];
    char mac_address[18*MAX_GUESTS_ALLOWED*2];
    char status[10*MAX_GUESTS_ALLOWED*2];
...
//void send_message(char* host, int port, char* message);
...
struct guest_info* convert_guest_list_str(char* guest_list_str);